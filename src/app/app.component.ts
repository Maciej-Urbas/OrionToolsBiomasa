...
export class AppComponent {
  ...
  scrollToRecycle() {
    ...
    heightHelper = document.querySelector('.steel')?.clientHeight;
    if (heightHelper != undefined) {
      scrollHeight = scrollHeight + heightHelper;
    }
  ...
  scrollToRegen() {
    ...
    heightHelper = document.querySelector('.recycle')?.clientHeight;
    if (heightHelper != undefined) {
      scrollHeight = scrollHeight + heightHelper;
    }
  ...
  scrollToNewest() {
    ...
    heightHelper = document.querySelector('.regen')?.clientHeight;
    if (heightHelper != undefined) {
      scrollHeight = scrollHeight + heightHelper;
    }
